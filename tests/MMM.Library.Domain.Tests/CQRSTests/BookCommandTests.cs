...
namespace MMM.Library.Domain.Tests.CQRTests
{
    public class BookCommandTests
    {
        ...
        public void New_Valid_Command()
        {
            ...
            //var command = new BookingItemCommandAdd(); // Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), book.ISBN, book.Title, book.Year, book.Language);
        ...
        public void New_InValid_Command()
        {
            ...
            //var command = new BookAddCommand(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), book.ISBN, book.Title, book.Year, book.Language);
