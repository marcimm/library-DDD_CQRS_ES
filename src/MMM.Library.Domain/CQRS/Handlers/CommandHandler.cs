...
namespace MMM.Library.Domain.CQRS.Handlers
{
    public abstract class CommandHandler
    {
        ...
        protected async Task<bool> ObjectExists<TEntity>(TEntity entity) where TEntity : Entity
        {
            ...
            await _mediatorHandler.PublishNotification(new Notification(entity.GetType().Name,
        ...
        protected bool ValidateCommand(Command message)
        {
            ...
            {
                _mediatorHandler.PublishNotification(new Notification(message.MessageType, error.ErrorMessage));
            }
