        ...
        public static void AddSwaggerSetup(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(s =>
            {
                s.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "API - V1 ",
                    Description = "Web Api Asp.Net Core 3.1",
                    Contact = new OpenApiContact { Name = "Márcio Molina Morassutti", Email = "marcio.molina.m@gmail.com", Url = new Uri("https://opensource.org/licenses/MIT") },
