...
using MMM.Library.Infra.CrossCutting.Identity.Extensions;
using System;
using System.Text;
    ...
    public static class IdentitySetup
    {
        public static void AddIdentitySetup(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDefaultIdentity<IdentityUser>()
                ...
                .AddErrorDescriber<PortugueseMessagesTranslation>()
        ...
        public static void AddAuthSetup(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                options.AddPolicy("IsDeveloper", policy =>
                                     policy.RequireClaim("IsDeveloper"));
